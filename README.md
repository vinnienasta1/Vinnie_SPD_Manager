...
[![Latest Release](https://img.shields.io/github/v/release/vinnienasta1/Vinnie_SPD_Manager?label=latest%20release&color=22c55e)](https://github.com/vinnienasta1/Vinnie_SPD_Manager/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/vinnienasta1/Vinnie_SPD_Manager/total?label=downloads&color=3b82f6)](https://github.com/vinnienasta1/Vinnie_SPD_Manager/releases)
[![Platform](https://img.shields.io/badge/platform-Windows%20x64-1f2937)](https://github.com/vinnienasta1/Vinnie_SPD_Manager/releases)
...
- Библиотека сэмплов;
- Встроенный конвертер WAV;
- Встроенный генератор клик-трека;
...
1. Скачай `Vinnie SPD Manager Installer.exe` из раздела Releases.
